...
class Cart extends BaseController
{
    ...
    */
    public function cartAdd()
    {
        ...
        (new CartService())->addToCart($this->request->param());
        $this->success();
    }
    ...
    public function cartEdit()
    {
        ...
        $result = (new CartService())->editToCart($this->request->param());
        if($result < 0){
    ...
    public function cartList()
    {
        ...
        $result = (new CartService())->cartList($bid,$category_id);
    ...
    public function cartDelete()
    {
        ...
        (new CartService())->cartDelete($bid,$cart_ids);
        $this->success();
    }
